  ...
  ***************************************************************************** */
  ...
  var ResNet = (function () {
      ...
      ResNet.prototype.predict = function (input) {
          var _this = this;
          return tf.tidy(function () {
              var asFloat = toFloatIfInt$1(input);
              var asBatch = asFloat.expandDims(0);
  ...
  var VALID_INPUT_RESOLUTION = [161, 193, 257, 289, 321, 353, 385, 417, 449, 481, 513, 801];
              ...
              return __generator(this, function (_e) {
                  switch (_e.label) {
                      case 0:
                          ...
                          _b = padAndResizeTo(input, [inputResolution, inputResolution]), resized = _b.resized, padding = _b.padding;
                      ...
                      case 2:
                          poses = _e.sent();
                          resultPoses = scaleAndFlipPoses(poses, [height, width], [inputResolution, inputResolution], padding, configWithDefaults.flipHorizontal);
